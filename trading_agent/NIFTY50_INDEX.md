...
5. **Test**: `python main_backtest.py` → select NSE
...
├─────────────────────────────────────────────────────────────────┤
│ collect_nifty50_15y_data.py                                     │
│ → Downloads 15 years (2010-2025) of NIFTY50 data               │
│ → 50 stocks, 195,000 bars                                      │
...
├─────────────────────────────────────────────────────────────────┤
│ prepare_nifty50_data.py                                         │
│ → Engineers 35+ technical indicators                            │
│ → Generates binary labels (up/down)                             │
│ → Handles missing data                                          │
│ → Output: data/nifty50_training_data.csv (50 MB)               │
└─────────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────────┐
│ STEP 3: MODEL TRAINING (30 minutes)                            │
├─────────────────────────────────────────────────────────────────┤
│ train_nifty50_models.py                                         │
│ → Creates walk-forward splits (10-12 folds)                    │
│ → Trains XGBoost/LightGBM models                               │
│ → Selects best model                                            │
│ → Grades A/B/C/D                                                │
│ → Output: Trained model + registry                             │
└─────────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────────┐
│ STEP 4: BACKTESTING & TRADING (Variable)                       │
├─────────────────────────────────────────────────────────────────┤
│ main_backtest.py / main_paper.py / main_live.py                 │
│ → Select NSE market                                             │
│ → Automatically uses trained model                              │
│ → Orchestrator enforces deployment gates                        │
└─────────────────────────────────────────────────────────────────┘
```
...
✓ Multiple sources (Yahoo Finance, NSEpy, synthetic)
✓ Automatic retry and fallback
✓ Data validation (OHLC constraints, volume)
...
### Grading & Deployment
✓ A/B/C/D automatic grading
✓ Model registry integration
✓ Orchestrator deployment gates
✓ Deployment status tracking (LIVE/PAPER/INCUBATOR/REJECTED)
...
```
├── For Quick Learning
│   ├── NIFTY50_QUICK_START.md (200 lines, 2 min read)
│   └── Run: python scripts/demo_nifty50_workflow.py (5 min)
│
├── For Complete Understanding
│   ├── NIFTY50_ML_TRAINING_SUMMARY.md (1,000 lines, 30 min read)
│   └── DATA_COLLECTION_GUIDE.md (1,500 lines, 60 min read)
│
├── For Delivery Details
│   └── NIFTY50_DELIVERY_SUMMARY.md (500 lines, 15 min read)
│
└── For Testing & Grading Framework
    └── FRAMEWORK_SUMMARY.md (750 lines, 20 min read)
```
...
✅ **Complete data collection system** (350 lines)
✅ **Automated feature engineering** (400 lines)
✅ **ML model training pipeline** (300 lines)
✅ **Full working demo** (400 lines)
✅ **Comprehensive documentation** (3,500+ lines)
✅ **Pre-generated demo data** (13 MB)
✅ **Installation script** (ready-to-use)
✅ **Multiple guides** (quick start, detailed, architecture)
...
🚀 **Let's get your NIFTY50 trading models trained!**
